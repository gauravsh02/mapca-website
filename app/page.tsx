    ...
    <div className='flex flex-col'>
      <section id='#' className='mt-0 lg:mt-16'>
        ...
        >
          ...
          {/* <div>
            <Image src="/banner/banner-3.png" alt="asd" className="w-48" width={2880} height={1200} priority />
          </div>
          <div>
            ...
            <div className='flex flex-col gap-2 md:flex-row my-2'>
              <div className='bg-dark-100 w-full md:w-4/12'>
                <div className='text-left text-2xl lg:px-14 px-8 py-4'>
                  ...
                  <a className='font-light cursor-pointer brand-primary-light' target='_blank' href='https://maps.app.goo.gl/vvzXDKgwsvMKv5PU8'>A -199, Basement Defence Colony<br />New Delhi 110024</a>
                </div>
                <div className='text-left text-2xl lg:px-14 px-8 py-4'>
                  <span className='flex'>
                  ...
                  <a className='font-light cursor-pointer brand-primary-light' target='_blank' href='https://wa.me/91991209303'>+91 991209303</a>
                </div>
                <div className='text-left text-2xl lg:px-14 px-8 py-4'>
                  <span className='flex'>
                  ...
                  <a className='font-light cursor-pointer brand-primary-light' href='tel:+01147078240'>011 47078240</a>
                </div>
                <div className='text-left text-2xl lg:px-14 px-8 py-4'>
                  <span className='flex'>
                  ...
                  <a className='font-light cursor-pointer brand-primary-light' href="mailto:mapfcadelhi@gmail.com">mapfcadelhi@gmail.com</a>
                </div>
              </div>
